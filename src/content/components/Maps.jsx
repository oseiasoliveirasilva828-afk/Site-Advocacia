export default function Map({ address }) {
  return (
    <div className="w-full max-w-4xl mx-auto">
      {/* Container do mapa - Responsivo com alturas otimizadas */}
      <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl
        h-[300px] sm:h-[350px] md:h-[400px] lg:h-[380px] xl:h-[420px]">
        {/* 
          Mobile: 300px
          Tablet: 400px
          Notebook (lg): 380px - mais compacto
          Desktop (xl): 420px - um pouco maior mas ainda confortável
        */}
